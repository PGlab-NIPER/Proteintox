...
def train_and_evaluate(X_train, y_train, X_test, y_test):
    """Train an SVM model, perform GridSearchCV, and evaluate the model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train and evaluate an SVM classifier using GridSearchCV.")

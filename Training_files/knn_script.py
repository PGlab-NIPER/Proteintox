...
def train_and_evaluate(X_train, y_train, X_test, y_test):
    """Train a KNN model, perform GridSearchCV, and evaluate the model."""
    ...
    grid_search = GridSearchCV(estimator=knn, param_grid=param_grid, cv=10, n_jobs=-1, verbose=2)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train and evaluate a KNN classifier using GridSearchCV.")
